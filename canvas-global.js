  ...
  function genererDiplom(elevNavn) {
    ...
    if (erIPad) {
      ...
      css += ''
        ...
        + '.grid { display:grid; grid-template-columns:repeat(3,1fr); grid-auto-rows:1fr; gap:7px 10px; flex:1; }'
        + '.celle { padding:6px 5px; min-height:0; }'
        + '.ikon { font-size:min(5rem,10vh); width:min(5rem,10vh); height:min(5rem,10vh); margin-bottom:6px; }'
